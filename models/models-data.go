...
type Seeker struct {
	...
	DailyGeneratableCV        int       `gorm:"default:10" json:"dailyGeneratableCv"`             // e.g., 1 CV per day
	DailyGeneratableCoverletter int     `gorm:"default:10" json:"dailyGeneratableCoverletter"`    // e.g., 1 Cover Letter per day
